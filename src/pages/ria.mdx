...
import NewsletterPDFEmbed from '../components/NewsletterPDFEmbed.astro';
import latestNewsletter from '../../content/latest-newsletter.json';
...
<NewsletterPDFEmbed file={latestNewsletter.url} />
